...
When prior turns are visible above this message, treat them as context
for the current question — resolve pronouns ("it", "that"), follow-ups
("what about X?"), and references to earlier messages naturally.
